...
# eeg_file = '0012_20230414_011358_exp01_v03.mff'
# beh_file = '0012_20230414_121357_exp01_v03.json'
...
blue45_boost_1f1 = snrs_cnd4_1f1_avg - snrs_cnd2_1f1_avg
blue45_boost_1f2 = snrs_cnd3_1f2_avg - snrs_cnd1_1f2_avg

# average across all channels
red135_boost = np.mean((red135_boost_1f1 + red135_boost_1f2) / 2)
blue45_boost = np.mean((blue45_boost_1f1 + blue45_boost_1f2) / 2)
...
blue45_boost_occ = np.mean(((blue45_boost_1f1 + blue45_boost_1f2) / 2)[ind_occ])
# ----------------------------------------------------------------------------
...
# Topography map of blue45 boost at 1f1:
im, _ = mne.viz.plot_topomap(blue45_boost_1f1, epochs.info, axes=axes[2, 2],
                             vlim=(vmin, vmax), show=False)
axes[2, 2].set(title='blue45 boost 1f1')
cp.add_snr_colorbar(fig, axes[2, 2], im)
# Topography map of blue45 boost at 1f2:
im, _ = mne.viz.plot_topomap(blue45_boost_1f2, epochs.info, axes=axes[3, 2],
                             vlim=(vmin, vmax), show=False)
axes[3, 2].set(title='blue45 boost 1f2')
